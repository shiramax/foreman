      ...
      module Macros
        ...
        module HostTemplate
          ...
          apipie :method, desc: "Returns a host ENC representation" do
                 # long_description: "External Node Classifier is a concept used by configuration management
          ...
          apipie :method, desc: "Returns a host parameter value" do
            # long_description: "Host can be assigned parameters. These are perfect match for conditional logic
            ...
            # is considered for all authorization checks." do
          ...
          apipie :method, desc: "Returns an array of puppet classes assigned to host" do
            # long_description: "Host can be assigned puppet classes either directly or through host groups and config
            # groups. This methods returns puppet class objects assigned to host directly." do
          ...
          apipie :method, desc: "Returns a true if a parameter is considered truthy" do
            # long_description: "Parameters tends to be used in conditions. Users who set parameters tends to use
          ...
          apipie :method, desc: "Returns a false if a parameter is considered falsy" do
            # long_description: "Parameters tends to be used in conditions. Users who set parameters tends to use
          ...
          apipie :method, desc: "Returns a root password hash for a host" do
            # long_description: "Root password can be set for host either directly, for host group or globally, using
          ...
          apipie :method, desc: "Returns a kickstart snippet for setting GRUB password for a host on bootloader line" do
            # long_description: "GRUB password can be set for host either direcrly or for host group. The value is
          ...
          apipie :method, desc: "Returns a kickstart snippet for setting a serial console" do
            # long_description: "A serial console can be configured in kickstart template using console parameter
